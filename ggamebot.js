...
module.exports = tobz = async (tobz, message) => {
    try {
        ...
        const ownerNumber = '6282368007398@c.us'
        ...
        const vhtearkey = 'Dim4z05' // https://api.vhtear.com
        const barbarkey = '0kE6iZh2ynVBKXnz2xeb' // https://mhankbarbar.herokuapp.com/api
...
${desc}`)
        ...
        case '#owner':
        case '#creator':
            tobz.sendContact(chatId, `6282368007398@c.us`)
...
🌐️ *URL*: ${url}`
        ...
        case '#nhentai': // SEARCH NHENTAI
            if (!isGroupMsg) return tobz.reply(from, 'Perintah ini hanya bisa di gunakan dalam group!', id)
            tobz.reply(from, 'PREMIUM COMMAND, HUBUNGI : wa.me/6282368007398', id)
          break
...
➸ *Wilayah:* +${region_name}`
        ...
        case '#help':
            ...
            break
        case '#elainagroup':
            tobz.reply(from, `Link Group Elaina : https://chat.whatsapp.com/DbiOMBADl2WHlGibihzAKj\nJangan Lupa Join Ya Kak ${pushname}`, id)
            break
        case '#groupmenu':
